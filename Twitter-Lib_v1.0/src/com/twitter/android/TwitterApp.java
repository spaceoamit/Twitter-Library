...
public class TwitterApp {
	...
	/*public static final String MESSAGE = "Hello Everyone...." + "<a href= "
			+ base_link_url + "</a>";*/
	User user;
		...
		new Thread() {
			...
			public void run() {
				...
				try {
					...
					Log.e("log_tag",""+mHttpOauthConsumer.getToken()+"-----"+mHttpOauthConsumer.getTokenSecret());
	...
	public static String getMapUrl(Double lat, Double lon, int width, int height) {
		...
		return "http://maps.googleapis.com/maps/api/staticmap?" + "&zoom=16"
				+ "&size=" + width + "x" + height
