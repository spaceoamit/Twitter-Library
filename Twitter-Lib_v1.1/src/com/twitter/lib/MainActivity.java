...
public class MainActivity extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		if (v == buttonLogin) {
			...
			//any test only 140 char
			String tweetString="Tweet in Lib :Test Tweet in Lib :Test Tweet in Lib :Test Tweet in Lib :"+System.currentTimeMillis();
			...
			mTwitterMain.sendTweetWithDialog(tweetString);
					...
					//this must be in sdcard not from resource
					String imageUrl=Environment.getExternalStorageDirectory().getAbsolutePath()+"/test.jpg";
